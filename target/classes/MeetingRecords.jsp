                                    ...
                                    <table class="display table table-striped table-bordered"
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                try {
                                                    connection = DBHandler.createDBConnection();
                                                    ResultSet resultSet = connection.createStatement().executeQuery("SELECT * FROM meeting_records ");
                                        ...
                                        <tr>
                                            ...
                                            <% if (resultSet.getString("RecordLink") == null) {%>
                                            <td style="text-align: center"></td>
                                            <%} else { %>
                                            <td style="text-align: center"><%=resultSet.getString("RecordLink") %>
                                            </td>
                                            <%}%>
                                            ...
                                            <td style="text-align: center">
                                                ...
                                                <button class="btn btn-danger" type="button" onclick="DeleteMeetingRecord('<%=resultSet.getString("UniqueClassId")%>', '<%=resultSet.getString("RecordLink")%>')">
